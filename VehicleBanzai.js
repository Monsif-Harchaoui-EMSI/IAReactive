  ...
  */
  ...
  class VehicleBanzai {
    ...
    constructor(x, y) {
      ...
      this.maxForce = 0.25;
      this.color = "white";
      this.image = loadImage("assets/Banzai.png"); 
    ...
    applyBehaviors(target, obstacles) {
      ...
      let separateForce = this.separate(Banzaivehicules);
    ...
    */
    ...
    drawVehicle() {
      ...
      if (this.image) {
        imageMode(CENTER);
        image(this.image, 0, 0, this.r_pourDessin * 3, this.r_pourDessin * 3);
      } else {
        fill(this.color);
        triangle(
          -this.r_pourDessin,
  ...
  class Target extends VehicleBanzai {
    constructor(x, y) {
      super(x, y);
